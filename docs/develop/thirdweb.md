...
description: Guide to deploy smart contracts using thirdweb
keywords:
  - docs
  - matic
  - polygon
...
5. After modifying your contract with your desired custom logic, you may deploy it to [Polygon](https://thirdweb.com/polygon) using [Deploy](https://portal.thirdweb.com/deploy).
